...
def displayBoard(missedLetters, correctLetters, secretWord):
    ...
    print()
    #como para dar una pista, se me ocurre imprimir la primera y la ultima letra de la palabra secreta
    pista = secretWord[0] + secretWord[len(secretWord)-1]
    print(f" la palabra empiza con {pista[0]} y termina con la letra: {pista[-1]} ")
